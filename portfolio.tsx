...
import { Sun, Github, Twitter, Linkedin, Mail, ExternalLink } from "lucide-react"
        ...
        {activeTab === "Projects" && (
          <div className="space-y-2">
            {projects.map((project, index) => (
              <div key={index} className="group my-4 border-2 border-red-400 ">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, techIndex) => (
                    <span key={techIndex} className="text-xs text-gray-400 bg-gray-900 px-2 py-1 rounded">
                      {tech}
                    </span>
                  ))}
                </div>
            ...
            {experience.map((experience, index) => (
              <div key={index} className="group">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-xl font-medium text-white">{experience.name}</h3>
